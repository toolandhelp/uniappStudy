<template>
  ...
  :qty="list.length"
  :totalQty="totalQty"
  :scrollAreaHeight="windowHeights - 10"
    ...
    async function search() {
      ...
      try {
        const { PageCount, Items,TotalRecordQty } =
          await todoController.todoWaitingApprovalBillList(
    ...
    function itemClick(billId, urlName) {
      switch (urlName) {
        case "RequestDrawDetail":
          navigateTo(
            `subcontract/asset/requestDraw/requestDraw?id=${billId}&type=mywork`
          );
          break;
        case "drawDetail":
          navigateTo(`subcontract/asset/draw/drawDetail?id=${billId}&type=mywork`);
          break;
        case "drawBackDetail":
          navigateTo(
            `subcontract/asset/drawBack/drawBackDetail?id=${billId}&type=mywork`
          );
          break;
        case "WaitReceivingListAdd":
          navigateTo(
            `subcontract/asset/takeDelivery/takeDelivery?id=${billId}&type=mywork`
          );
          break;
        case "transformDetail":
          navigateTo(
            `subcontract/asset/transform/detail?id=${billId}&type=mywork`
          );
          break;
        case "requestDiscardDetail":
          navigateTo(
            `subcontract/asset/requestDiscard/detail?id=${billId}&type=mywork`
          );
          break;
        case "discardDetail":
          navigateTo(
            `subcontract/asset/discard/detail?id=${billId}&type=mywork`
          );
          break;
        case "ComRequestDrawDetail":
          navigateTo(
            `subcontract/consumable/requestDraw/requestDraw?id=${billId}&type=mywork`
          );
          break;
        case "ComInWarehouseDetail":
          navigateTo(
            `subcontract/consumable/inwarehouse/detail/detail?id=${billId}&type=mywork`
          );
          break;
        case "ComOutWarehouseDetail":
          navigateTo(
            `subcontract/consumable/outwarehouse/detail/detail?id=${billId}&type=mywork`
          );
          break;
        case "ComAllocateDetail":
          navigateTo(
            `subcontract/consumable/allocate/detail/detail?id=${billId}&type=mywork`
          );
          break;
        case "ComDiscardDetail":
          navigateTo(
            `subcontract/consumable/discard/detail/detail?id=${billId}&type=mywork`
          );
          break;
      }
    }
