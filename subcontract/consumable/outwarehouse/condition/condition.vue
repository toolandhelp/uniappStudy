	...
	<view class="screen">
		<view class="condition_list">
			...
			<view class="condition_item_selector">
				...
				<view class="content">
					<picker mode="date" @change="bindOutWarehouseStartDatePickerChange">
						<text class="info-item-text">
							{{
					      Data.OutWarehouseStartDate ? Data.OutWarehouseStartDate:"入库日期起"
					    }}
						</text>
					</picker>
				...
				<view class="right ">
					<icon type="clear" size="14" style="vertical-align: bottom;"
						@click="clearInputText('OutWarehouseStartDate')" v-if="Data.OutWarehouseStartDate" />
				</view>
			</view>
			<view class="condition_item_selector">
				<view class="left">
				...
				<view class="content">
					<picker mode="date" @change="bindOutWarehouseEndDatePickerChange">
						<text class="info-item-text">
							{{
				        Data.OutWarehouseEndDate ? Data.OutWarehouseEndDate:"入库日期止"
				      }}
						</text>
					</picker>
				</view>
				<view class="right">
					<icon type="clear" size="14" style="vertical-align: bottom;"
						@click="clearInputText('OutWarehouseEndDate')" v-if="Data.OutWarehouseEndDate" />
				</view>
			</view>
		</view>
