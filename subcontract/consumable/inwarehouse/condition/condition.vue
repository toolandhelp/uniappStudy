	...
	<view class="screen">
		<view class="condition_list">
			...
			<view class="condition_item_selector">
				...
				<view class="content">
					<input class="uni-input" focus placeholder="请选择供应商" :value="getSupplierText()"
						@click="getSupplierIDs" disabled="true" />
				</view>
				<view class="right">
					<icon type="clear" size="14" style="vertical-align: bottom;" @click="clearInputText('Supplier')"
						v-if="getSupplierText()" />
				</view>
			</view>
			<view class="condition_item_selector">
				<view class="left">
				...
				<view class="content">
					<picker mode="date" @change="bindInWarehouseStartDatePickerChange">
						<text class="info-item-text">
							{{
					      Data.InWarehouseStartDate ? Data.InWarehouseStartDate:"入库日期起"
					    }}
						</text>
					</picker>
				...
				<view class="right ">
					<icon type="clear" size="14" style="vertical-align: bottom;"
						@click="clearInputText('InWarehouseStartDate')" v-if="Data.InWarehouseStartDate" />
				</view>
			</view>
			<view class="condition_item_selector">
				<view class="left">
				...
				<view class="content">
					<picker mode="date" @change="bindInWarehouseEndDatePickerChange">
						<text class="info-item-text">
							{{
				        Data.InWarehouseEndDate ? Data.InWarehouseEndDate:"入库日期止"
				      }}
						</text>
					</picker>
				</view>
				<view class="right">
					<icon type="clear" size="14" style="vertical-align: bottom;"
						@click="clearInputText('InWarehouseEndDate')" v-if="Data.InWarehouseEndDate" />
				</view>
			</view>
		</view>
