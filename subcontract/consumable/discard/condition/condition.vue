	...
	<view class="screen">
		<view class="condition_list">
			...
			<view class="condition_item_selector">
				...
				<view class="content">
					<picker mode="date" @change="bindDiscardStartDatePickerChange">
						<text class="info-item-text">
							{{
					      Data.DiscardStartDate ? Data.DiscardStartDate:"调拨日期起"
					    }}
						</text>
					</picker>
				...
				<view class="right ">
					<icon type="clear" size="14" style="vertical-align: bottom;"
						@click="clearInputText('DiscardStartDate')" v-if="Data.DiscardStartDate" />
				</view>
			</view>
			<view class="condition_item_selector">
				<view class="left">
				...
				<view class="content">
					<picker mode="date" @change="bindDiscardEndDatePickerChange">
						<text class="info-item-text">
							{{
				        Data.DiscardEndDate ? Data.DiscardEndDate:"调拨日期止"
				      }}
						</text>
					</picker>
				</view>
				<view class="right">
					<icon type="clear" size="14" style="vertical-align: bottom;"
						@click="clearInputText('DiscardEndDate')" v-if="Data.DiscardEndDate" />
				</view>
			</view>
		</view>
