...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    e: common_vendor.o($setup.submitDialogConfirm),
    f: common_vendor.o(($event) => $setup.submitDialog.close()),
    g: common_vendor.p({
      model: "base",
      ["before-close"]: true,
      type: "info",
    ...
    i: common_vendor.f($setup.registerList, (item, index, i0) => {
      return common_vendor.e({
        a: index == 0 || index == 7
      }, index == 0 || index == 7 ? {} : {}, {
        b: index == 0 || index == 7
    ...
    k: common_vendor.o($setup.select),
    l: common_vendor.o($setup.deletefile),
    m: common_vendor.o(($event) => $setup.files = $event),
    n: common_vendor.p({
      limit: 5,
    ...
    p: common_vendor.o((...args) => $setup.saveSubmit && $setup.saveSubmit(...args)),
    q: common_vendor.o((...args) => $setup.cancel && $setup.cancel(...args))
  });
}
