...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    w: common_vendor.o($setup.select),
    x: common_vendor.o($setup.deletefile),
    y: common_vendor.o(($event) => $setup.files = $event),
    z: common_vendor.p({
      limit: 9,
    ...
    B: common_vendor.o((...args) => $setup.save && $setup.save(...args)),
