...
const _sfc_main = {
  ...
  setup({ id, type }) {
    ...
    function approvalShow() {
      ...
      service_controller_asset_requestDrawController.requestDrawController.requestDrawPrevApproval(bill.value.id).then((dataInfo) => {
        const {
          ActivityID,
          ActivityName,
          ActivityType,
    ...
    function submitApproval({ approvalType, refuseType, remark }) {
      ...
      service_controller_asset_requestDrawController.requestDrawController.requestDrawSubmitApproval(obj).then(({ ID }) => {
    ...
    function enablingApprovalShow() {
      ...
      service_controller_asset_requestDrawController.requestDrawController.requestDrawPreStartFlow(bill.value.id).then(({
        ActivityID,
        ActivityName,
        ActivityType,
        NextActivityID,
    ...
    function approveStartConfirm(val) {
      ...
      service_controller_asset_requestDrawController.requestDrawController.requestDrawStartFlow(approveData).then(async ({ ID }) => {
        bill.value.startFlow = false;
    ...
    function processTrack() {
      share_util_message.showLoading();
      service_controller_asset_requestDrawController.requestDrawController.requestDrawGetFlowTrail(bill.value.id).then(({ ApprovalLog, ApprovalTask }) => {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    s: common_vendor.f($setup.serachGoodsList, ({
      ID,
      Name,
      Code,
      AssetCategoryName,
    ...
    aq: common_vendor.n($setup.bill.applyReason.value ? "info-item-color" : "")
  }, {
    ...
    aG: common_vendor.f($setup.billDetail, (item, index, i0) => {
      return {
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-395f74c6"], ["__file", "D:/gitPro/C8_UI/platformApp/subcontract/asset/requestDraw/requestDraw.vue"]]);
