    ...
    function trigger({ item: { code } }) {
      ...
      switch (code) {
        ...
        case service_enumeration_fastAssetBtn.fastAssetBtn.repair:
          share_redirect_index.navigateTo(`subcontract/asset/repairRequest/repairRequestDetail?id=${id}`);
          break;
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    h: common_vendor.t($setup.asset.Code),
    i: common_vendor.t($setup.asset.OriginalCode),
    j: common_vendor.t($setup.asset.SN),
    k: common_vendor.t($setup.asset.Name),
    l: common_vendor.t($setup.asset.CategoryName),
    m: common_vendor.t($setup.asset.Brand),
    n: common_vendor.t($setup.asset.Spec),
    o: common_vendor.t($setup.asset.Model),
    p: common_vendor.t($setup.asset.Qty),
    q: common_vendor.t($setup.asset.Unit),
    r: common_vendor.t($setup.asset.IsRequiredStockChecking ? "\u662F" : "\u5426"),
    s: common_vendor.t($setup.timeConvertDate($setup.asset.DateOfPurchase)),
    t: common_vendor.t($setup.asset.AssetPurposeText),
    v: common_vendor.t($setup.asset.AcquireWayText),
    w: common_vendor.t($setup.asset.AssetAttributeText),
    x: common_vendor.t($setup.asset.AssetStatusText),
    y: common_vendor.t($setup.asset.AssetDesc),
    z: common_vendor.t($setup.asset.Remark),
    A: common_vendor.p({
      title: "\u57FA\u672C\u4FE1\u606F",
      type: "line"
    }),
    B: common_vendor.t($setup.asset.CorpName),
    C: common_vendor.t($setup.asset.KAOName),
    D: common_vendor.t($setup.asset.KAEName),
    E: common_vendor.t($setup.asset.UAOName),
    F: common_vendor.t($setup.asset.UAEName),
    G: common_vendor.t($setup.asset.LocationName),
    H: common_vendor.t($setup.asset.DetailAddress),
    I: common_vendor.t($setup.timeConvertDate($setup.asset.DatetimeOfUse)),
    J: common_vendor.t($setup.timeConvertDate($setup.asset.ExpiredDateOfMaintenance)),
    K: common_vendor.t($setup.timeConvertDate($setup.asset.NextMaintenanceDate)),
    L: common_vendor.t($setup.timeConvertDate($setup.asset.ExpiredDateOfUsage)),
    M: common_vendor.t($setup.timeConvertDate($setup.asset.RegisterDatetime)),
    N: common_vendor.t($setup.timeConvertDate($setup.asset.FirstDrawDate)),
    O: common_vendor.t($setup.timeConvertDate($setup.asset.RequestDiscardDate)),
    P: common_vendor.f($setup.asset.AssetUsage, (item, index, i0) => {
      return common_vendor.e({
    ...
    R: common_vendor.t($setup.asset.SourceChannel),
    S: common_vendor.t($setup.asset.SourceCode),
    T: common_vendor.p({
      title: "\u6570\u636E\u6765\u6E90",
      type: "line"
    }),
    U: $setup.imgs.length === 0
  }, $setup.imgs.length === 0 ? {} : {}, {
    V: common_vendor.f($setup.imgs, (img, i, i0) => {
      return {
    ...
    Z: common_vendor.o($setup.trigger),
    aa: common_vendor.p({
