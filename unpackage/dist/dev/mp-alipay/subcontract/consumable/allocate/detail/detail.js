...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    aD: common_vendor.t($setup.bill.fromWarehouse.Name ? $setup.bill.fromWarehouse.Name : "\u8BF7\u9009\u62E9\u8C03\u51FA\u4ED3\u5E93"),
    aE: common_vendor.n($setup.bill.fromWarehouse.Name ? "info-item-color" : ""),
    ...
    aH: $setup.nonEditable ? false : $setup.bill.fromWarehouse.ID
  }, ($setup.nonEditable ? false : $setup.bill.fromWarehouse.ID) ? {
    aI: common_vendor.o(($event) => $setup.removeInput("fromWarehouse")),
    aJ: common_vendor.p({
      type: "close",
      size: "16"
    })
    ...
    aL: common_vendor.t($setup.bill.toWarehouse.Name ? $setup.bill.toWarehouse.Name : "\u8BF7\u9009\u62E9\u8C03\u5165\u4ED3\u5E93"),
    aM: common_vendor.n($setup.bill.toWarehouse.Name ? "info-item-color" : ""),
    aN: common_vendor.o(($event) => $setup.nonEditable ? null : $setup.openToWarehouseSelector()),
    aO: !$setup.nonEditable
  }, !$setup.nonEditable ? common_vendor.e({
    aP: $setup.nonEditable ? false : $setup.bill.toWarehouse.ID
  }, ($setup.nonEditable ? false : $setup.bill.toWarehouse.ID) ? {
    aQ: common_vendor.o(($event) => $setup.removeInput("toWarehouse")),
    aR: common_vendor.p({
      type: "close",
      size: "16"
    })
    ...
    aT: common_vendor.t($setup.bill.allocateDate ? $setup.bill.allocateDate : "\u8BF7\u9009\u62E9\u65E5\u671F"),
    aU: common_vendor.n($setup.bill.allocateDate ? "info-item-color" : ""),
    aV: common_vendor.o((...args) => $setup.allocateDateTimeChange && $setup.allocateDateTimeChange(...args)),
    aW: !$setup.nonEditable
  }, !$setup.nonEditable ? common_vendor.e({
    aX: $setup.nonEditable ? false : $setup.bill.allocateDate
  }, ($setup.nonEditable ? false : $setup.bill.allocateDate) ? {
    aY: common_vendor.o(($event) => $setup.removeInput("allocateDate")),
    aZ: common_vendor.p({
      type: "close",
      size: "16"
    })
    ...
    bb: common_vendor.t($setup.bill.handledPerson.ID ? $setup.bill.handledPerson.Name : "\u8BF7\u9009\u62E9\u4EBA\u5458"),
    bc: common_vendor.o(($event) => $setup.nonEditable ? null : $setup.openPersonSelector()),
    bd: common_vendor.n($setup.bill.handledPerson.ID ? "info-item-color" : ""),
    be: !$setup.nonEditable
  }, !$setup.nonEditable ? common_vendor.e({
    bf: $setup.nonEditable ? false : $setup.bill.handledPerson.ID
  }, ($setup.nonEditable ? false : $setup.bill.handledPerson.ID) ? {
    bg: common_vendor.o(($event) => $setup.removeInput("handledPerson")),
    bh: common_vendor.p({
      type: "close",
      size: "16"
    })
    ...
    bj: $setup.nonEditable == null,
    bk: $setup.bill.remark,
    bl: common_vendor.o(($event) => $setup.bill.remark = $event.detail.value),
    ...
    br: common_vendor.s(`height:${$setup.IsScroll.header}px`),
    bs: common_vendor.t($setup.totalQuantity()),
    bt: common_vendor.t($setup.totalAmount()),
    ...
    bA: common_vendor.o(_ctx.deletefile),
    ...
    bN: common_vendor.o((...args) => $setup.jumpList && $setup.jumpList(...args))
  } : {}, {
    bO: $setup.bill.status == 1 || $setup.bill.status == null
  }, $setup.bill.status == 1 || $setup.bill.status == null ? {
    bP: common_vendor.o(($event) => $setup.handleSaveDraft(0))
  } : {}, {
    bQ: $setup.bill.status == 1
  }, $setup.bill.status == 1 ? {
    bR: common_vendor.o((...args) => $setup.billDelete && $setup.billDelete(...args))
  } : {}, {
    bS: $setup.bill.status == 1 || $setup.bill.status == null
  }, $setup.bill.status == 1 || $setup.bill.status == null ? {
    bT: common_vendor.o(($event) => $setup.handleSaveDraft(1))
  } : {}, {
    bU: $setup.bill.IsApproval
  }, $setup.bill.IsApproval ? {
    bV: common_vendor.o((...args) => $setup.approvalShow && $setup.approvalShow(...args))
  } : {}, {
    bW: $setup.bill.IsStart && $setup.bill.startFlow
  }, $setup.bill.IsStart && $setup.bill.startFlow ? {
    bX: common_vendor.o((...args) => $setup.enablingApprovalShow && $setup.enablingApprovalShow(...args))
  } : {}, {
    bY: $setup.bill.FlowPath
  }, $setup.bill.FlowPath ? {
    bZ: common_vendor.o((...args) => $setup.processTrack && $setup.processTrack(...args))
  } : {}, {
    ca: $setup.bill.status == 7
  }, $setup.bill.status == 7 ? {
    cb: common_vendor.o((...args) => $setup.sign && $setup.sign(...args))
  } : {});
}
