...
const _sfc_main = {
  ...
  setup({
    ...
    service_controller_asset_basicDataController.basicDataController.getLocationTree(insideIsPower, parentId).then(({ Items }) => {
      list.value = Items;
    }).finally(share_util_message.clearLoading);
    function treeItemClick(item) {
      share_util_uniEvent.emit(service_enumeration_eventNames.eventNames.locationSelectBack, item);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.o($setup.treeItemClick),
    b: common_vendor.p({
      list: $setup.list,
      idKey: "id",
      nameKey: "label",
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/gitPro/C8_UI/platformApp/pages/selector/asset/location.vue"]]);
