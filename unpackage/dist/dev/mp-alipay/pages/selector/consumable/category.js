...
const _sfc_main = {
  ...
  setup({ isLast = "0", multiple = "0", ids = "" }) {
    ...
    service_controller_consumable_basicDataController.BasicDataController.getCategoryTree().then(({ Items }) => list.value = Items).finally(share_util_message.clearLoading);
    function treeDone(item) {
      share_util_uniEvent.emit(service_enumeration_eventNames.eventNames.consumableCategoryBack, item);
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/gitPro/C8_UI/platformApp/pages/selector/consumable/category.vue"]]);
