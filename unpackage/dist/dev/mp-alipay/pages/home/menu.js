...
var share_util_page = require("../../share/util/page.js");
const commonMenus = [
  {
...
function setNavigationTitle() {
  const res = _setNavigationTitle(share_util_page.getCurrentPage().route);
  if (res === false) {
    share_util_index.awaitDelay(50).then(() => {
      _setNavigationTitle(share_util_page.getCurrentPage().route);
    });
  }
}
exports.assetMenus = assetMenus;
exports.commonMenus = commonMenus;
exports.consumableMenus = consumableMenus;
