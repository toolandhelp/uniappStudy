...
const _sfc_main = {
  emits: ["uploadFiles", "getFileUrl", "choose", "delFile"],
  props: {
    filesList: {
      type: Array,
      default() {
  ...
  return common_vendor.e({
    ...
    d: common_vendor.f($options.list, (item, index, i0) => {
      return common_vendor.e({
        ...
        c: common_vendor.o(($event) => $options.getFileUrl(item)),
        ...
        i: index,
        j: index !== 0 && $options.styles.dividline ? 1 : "",
        k: common_vendor.s(index !== 0 && $options.styles.dividline && $options.borderLineStyle)
      });
    }),
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/gitPro/C8_UI/platformApp/components/uni-file-picker/components/uni-file-picker/upload-file.vue"]]);
