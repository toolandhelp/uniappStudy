...
const _sfc_main = {
  ...
  setup() {
    ...
    async function search() {
      ...
      try {
        const { PageCount, Items, TotalRecordQty } = await service_controller_myWork_doneController.doneController.Done(share_util_storage.getStorage("EmployeeID"), currentPage);
        pageCount = PageCount;
        if (currentPage === 1) {
          list.value = Items;
        } else {
    ...
    function itemClick(billId, urlName) {
      switch (urlName) {
        case "RequestDrawDetail":
          share_redirect_index.navigateTo(`subcontract/asset/requestDraw/requestDraw?id=${billId}&type=list`);
          break;
        case "drawDetail":
          share_redirect_index.navigateTo(`subcontract/asset/draw/drawDetail?id=${billId}&type=list`);
          break;
        case "drawBackDetail":
          share_redirect_index.navigateTo(`subcontract/asset/drawBack/drawBackDetail?id=${billId}&type=list`);
          break;
        case "WaitReceivingListAdd":
          share_redirect_index.navigateTo(`subcontract/asset/takeDelivery/takeDelivery?id=${billId}&type=list`);
          break;
        case "transformDetail":
          share_redirect_index.navigateTo(`subcontract/asset/transform/detail?id=${billId}&type=list`);
          break;
        case "requestDiscardDetail":
          share_redirect_index.navigateTo(`subcontract/asset/requestDiscard/detail?id=${billId}&type=list`);
          break;
        case "discardDetail":
          share_redirect_index.navigateTo(`subcontract/asset/discard/detail?id=${billId}&type=list`);
          break;
        case "ComRequestDrawDetail":
          share_redirect_index.navigateTo(`subcontract/consumable/requestDraw/requestDraw?id=${billId}&type=list`);
          break;
        case "ComInWarehouseDetail":
          share_redirect_index.navigateTo(`subcontract/consumable/inwarehouse/detail/detail?id=${billId}&type=list`);
          break;
        case "ComOutWarehouseDetail":
          share_redirect_index.navigateTo(`subcontract/consumable/outwarehouse/detail/detail?id=${billId}&type=list`);
          break;
        case "ComAllocateDetail":
          share_redirect_index.navigateTo(`subcontract/consumable/allocate/detail/detail?id=${billId}&type=list`);
          break;
        case "ComDiscardDetail":
          share_redirect_index.navigateTo(`subcontract/consumable/discard/detail/detail?id=${billId}&type=list`);
          break;
      }
    }
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.p({
      ...
      scrollAreaHeight: $setup.windowHeights - 46,
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/gitPro/C8_UI/platformApp/subcontract/mine/done/done.vue"]]);
