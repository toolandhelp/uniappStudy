...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    m: common_vendor.sr("inputClose", "348d3bcc-2,348d3bcc-1"),
    n: common_vendor.o($options.dialogsearchCodeValConfirm),
    o: common_vendor.p({
      mode: "input",
      title: "\u9009\u62E9\u6613\u8017\u54C1\u5E93\u5B58",
    ...
    p: common_vendor.sr("scanCodeDialog", "348d3bcc-1"),
    q: common_vendor.p({
      type: "dialog"
    }),
    r: common_vendor.sr("fab", "348d3bcc-3"),
    s: common_vendor.o($options.fabTrigger),
    t: common_vendor.o($options.fabClick),
    v: common_vendor.p({
