...
const _sfc_main = {
  ...
  setup({ id, type }) {
    ...
    function addQuery(keyWorld) {
      ...
      service_controller_consumable_requestDrawController.requestDrawController.consumableFuzzyQuery(keyWorld).then((Items) => {
        ...
        if (serachConsumableList.value.length < 1) {
          share_util_message.showErrorToast("\u65E0\u5339\u914D\u8D44\u4EA7\u8D44\u6599");
          return;
        }
    ...
    function editBillDetail(index) {
      ...
      const { Code, ConsumableName, Brand, Spec, Model, Qty } = billDetail.value[index];
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: common_vendor.sr("inputClose", "6e368cfa-1,6e368cfa-0"),
    ...
    d: common_vendor.sr("inputRemarkDialog", "6e368cfa-0"),
    e: common_vendor.p({
      type: "dialog"
    }),
    ...
    i: common_vendor.sr("submitDialog", "6e368cfa-2"),
    j: common_vendor.p({
      type: "dialog"
    }),
    k: common_vendor.f($setup.serachConsumableList, ({
      ConsumableID,
      ConsumableName,
      Code,
      CategoryName,
    ...
    p: common_vendor.sr("goodsDialog", "6e368cfa-4"),
    q: common_vendor.p({
      type: "dialog"
    }),
    ...
    t: common_vendor.t($setup.rowDetail.consumableName),
    v: common_vendor.p({
      disabled: true
    }),
    ...
    E: common_vendor.sr("inputClose", "6e368cfa-9,6e368cfa-8"),
    ...
    I: common_vendor.sr("inputDialog", "6e368cfa-8"),
    J: common_vendor.p({
      type: "center"
    }),
    K: !$setup.nonEditable
    ...
    aI: common_vendor.f($setup.billDetail, (item, index, i0) => {
      return common_vendor.e({
        ...
        c: "6e368cfa-32-" + i0 + "," + ("6e368cfa-31-" + i0),
        d: common_vendor.p({
          type: "compose",
          size: "30",
          color: "#444"
        ...
        f: common_vendor.t(item.CategoryName),
        g: common_vendor.t(item.Brand),
        h: common_vendor.t(item.Spec),
        i: common_vendor.t(item.Model),
        j: common_vendor.t(item.Qty),
        k: common_vendor.s(index + 1 == $setup.billDetail.length ? "margin-bottom:0px" : ""),
        l: common_vendor.o(($event) => $setup.uniSwipeChange(index), item.ConsumableID),
        m: item.ConsumableID,
        n: common_vendor.o(($event) => $setup.uniSwipeClick($event, index), item.ConsumableID),
        o: "6e368cfa-31-" + i0 + ",6e368cfa-30",
        p: common_vendor.p({
          disabled: $setup.nonEditable,
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/gitPro/C8_UI/platformApp/subcontract/consumable/requestDraw/requestDraw.vue"]]);
