...
const _sfc_main = {
  ...
  setup({ id, employeeTaskID }) {
    ...
    function itemClick(id2) {
      share_redirect_index.navigateTo(`subcontract/asset/assetInfo/assetView?id=${id2}&type=list`);
    }
...
if (!Array) {
  ...
  (_component_AnchorPointAndQty + _easycom_uni_popup_dialog2 + _easycom_uni_popup2 + _easycom_uni_icons2)();
}
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.o($setup.saveDialogConfirm),
    d: common_vendor.p({
      model: "base",
      type: "info",
      cancelText: "\u53D6\u6D88",
    ...
    e: common_vendor.sr("saveDialog", "4f416d65-1"),
    f: common_vendor.p({
      type: "dialog"
    }),
    g: common_vendor.o($setup.inputCodeConfirm),
    h: common_vendor.p({
      mode: "input",
      title: "\u8F93\u5165\u8D44\u4EA7\u7F16\u7801\u68C0\u7D22\u8D44\u4EA7",
      value: "",
    ...
    i: common_vendor.sr("inputCodeDialog", "4f416d65-3"),
    j: common_vendor.p({
      type: "dialog"
    }),
    k: common_vendor.t($props.code),
    l: common_vendor.t($props.title),
    m: common_vendor.t($setup.list.length),
    n: common_vendor.o(($event) => $setup.saveDialog.open()),
    o: common_vendor.f($setup.list, ({
      ...
      return common_vendor.e({
        ...
        d: common_vendor.t(KAOName),
        e: common_vendor.t(KAEName),
        f: common_vendor.t(UAOName),
        g: common_vendor.t(UAEName),
        h: common_vendor.t(LocationName),
        i: common_vendor.t(StockConfirmResultText != null ? StockConfirmResultText : $setup.confirmResult.lack),
        j: common_vendor.n(`confirm-tag ${$setup.getColor(StockConfirmResultText)}`),
        k: InventoryModel === 1
      }, InventoryModel === 1 ? {
        l: common_vendor.o(($event) => $setup.stockConfirm($setup.list[index]))
      } : {}, {
        m: common_vendor.t(ActualQty),
        n: common_vendor.t(StockCheckDesc),
        o: TaskAssetID,
        p: common_vendor.o(($event) => $setup.itemClick(TaskAssetID), TaskAssetID)
      });
    }),
    p: $setup.list.length < 1
  }, $setup.list.length < 1 ? {
    q: common_vendor.s(`height:${$setup.windowHeights - 138}px`)
  } : {}, {
    r: common_vendor.s(`height:${$setup.windowHeights - 138}px`),
    s: common_vendor.o((...args) => _ctx.reachBottom && _ctx.reachBottom(...args)),
    t: common_vendor.o((...args) => $setup.scroll && $setup.scroll(...args)),
    v: $setup.toIndex,
    w: common_vendor.p({
      type: "compose",
      color: "#2979ff",
    ...
    x: common_vendor.o(($event) => $setup.inputCodeDialog.open()),
    y: common_vendor.p({
      type: "scan",
      color: "#2979ff",
      size: "26"
    }),
    z: common_vendor.o((...args) => $setup.scan && $setup.scan(...args))
  });
}
