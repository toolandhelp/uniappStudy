...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    e: common_vendor.sr("filePicker", "3cf27e49-2,3cf27e49-1"),
    f: common_vendor.o($setup.select),
    g: common_vendor.o($setup.deleteImg),
    h: common_vendor.o(($event) => $setup.imgs = $event),
    i: common_vendor.p({
    ...
    k: common_vendor.o((...args) => $setup.save && $setup.save(...args)),
    l: common_vendor.o((...args) => $setup.cancel && $setup.cancel(...args))
  });
}
